...
combined_df.to_csv('Predictions-2.5.csv', index=False)  # Save the dataframe to a csv file without row index
...
coef_df_sorted.to_csv('coefficients-2,5.csv', index=True)
...
Highest_coef.to_csv('selected_measurables-2.5.csv', index=False)
