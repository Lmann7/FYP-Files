...
combined_df.to_csv('RF-Pred-2.6-E-S.csv', index=False)  # Save the dataframe to a csv file without row index
...
plt.title('Importances for Model')
...
coef_df_sorted2.to_csv('RF-importances-2.6-E-S.csv', index=True)
...
Highest_coef.to_csv('RF-selected_measurables-2.6-E-S.csv', index=False)
