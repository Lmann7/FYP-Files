...
combined_df.to_csv('Predictions-4-E-S.csv', index=False)  # Save the dataframe to a csv file without row index
...
coef_df_sorted2.to_csv('coefficients-4-E-S.csv', index=True)
...
Highest_coef.to_csv('selected_measurables-4-E-S.csv', index=False)
...
filtered_importance = feature_importance[feature_importance['Importance'] > .02]
